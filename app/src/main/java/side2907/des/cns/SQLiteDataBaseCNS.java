...
//// TODO: 21.08.2016 Add time field 
    ...
    private static final String DB_SCRIPT = "CREATE TABLE "+DATABASE_TABLE+" ("+BaseColumns._ID+" INTEGER PRIMARY KEY AUTOINCREMENT, " + NAME + " TEXT, "+ DATE + " TEXT, "+ TEXT + " TEXT, "+ IMAGE + " TEXT);";
